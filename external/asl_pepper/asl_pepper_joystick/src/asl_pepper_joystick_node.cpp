...
//       const static std::string kDownPadGesture  = "animations/Stand/Gestures/ShowFloor_2";
      ...
      const static std::size_t kLRGesturePadAxisId = 4;
      const static std::size_t kUDGesturePadAxisId = 5;
      const static std::size_t kRotationModifierButton = 4; // Top left bumper
      const static std::size_t kCenterHeadButton = 11; // Click right joystick
      const static std::size_t kSaySomethingButton = 1; // A (green)
      const static std::size_t kSayBlockedButton = 3; // Y (yellow)
      const static std::size_t kKillMoveButton = 2; // B (red)
      const static std::size_t kResumeAutonomousMotionButton = 9; // start
