...
class DrSpaamROS():
    ...
    def __init__(self):
        ...
        self._detector = Detector(
            ...
            gpu=False, stride=self.stride) #MFR: gpu Changed to false
    ...
    def _scan_callback(self, msg):
        ...
        if not self._detector.laser_spec_set():
            ...
            self._detector.set_laser_spec(ang_inc, num_pts)

        # Need to filter the messages, scanner min range? Not done in the other
        ...
        # Need to rotate that, weird conventions somehow. 
